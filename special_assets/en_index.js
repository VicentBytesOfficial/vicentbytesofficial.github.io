...
async function iniciar() {
  ...
  await write("I am VicentBytes, an independent developer who creates apps and tools, but I'm still a bit of a beginner and learning...", ".p4", 20);
...
async function projectslinks() {
  ...
  await write("FamilyDataBase is a program that uses the TCP server system to move files from one computer to another...", ".projectdesc2", 20)
}
